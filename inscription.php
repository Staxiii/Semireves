<?php require_once 'elements/php/signup.php' ?>
								...
								<div class="m-sm-3">
									<form method="POST">
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg input-inscription <?php if(isset($erreurEmail)) { echo ' erreur-form-input';}?>" type="email" name="email" placeholder="Entrer votre adresse mail">
											<div class="erreur-form-inscription">
												<span><?php if(isset($erreurEmail)) { echo $erreurEmail; } ?></span>
											</div>
										</div>
										<div class="mb-3">
